...
for league in $LEAGUES
    for comp in $COMPETITIONS
        ...
        julia --project=. -t 10 simulate-remaining.jl -n 10000000 $OUTDIR/$comp/$league/tournaments/tournament-$CURRENT_DATE.json $OUTDIR/models/rpi-gaussian.json -o $OUTDIR/$comp/$league/output/simulations-$CURRENT_DATE.parquet
